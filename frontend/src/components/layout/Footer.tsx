      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Your trusted partner in finding the perfect home. We connect you with the best properties and expert agents to make your real estate dreams come true.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/listings" className="text-gray-300 hover:text-primary transition-colors">Browse Properties</a></li>
              <li><a href="/auth" className="text-gray-300 hover:text-primary transition-colors">Sign In</a></li>
              <li><a href="/auth/register" className="text-gray-300 hover:text-primary transition-colors">Create Account</a></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} PropEx Real Estate. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
