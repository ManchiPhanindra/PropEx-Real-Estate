...
import { createListing, getAllListings, getListingById, updateListing, deleteListing, getAgentListings } from '../controllers/listing.js';
...
router
    ...
    .post(restrictTo('Agent', 'Admin'), // Only Agents and Admins can create listings
uploadListingImages, // Middleware to process image files (Multer)
createListing);
router
    .route('/:id')
    // PATCH /api/listings/:id: Update listing details
    .patch(restrictTo('Agent', 'Admin'), uploadListingImages, // Allow image uploads/updates during patch
updateListing)
    // DELETE /api/listings/:id: Remove a listing
    .delete(restrictTo('Agent', 'Admin'), deleteListing);
